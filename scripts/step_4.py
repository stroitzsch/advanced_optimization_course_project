"""Step 4: Solving the problem in a decomposed manner."""
...
if __name__ == '__main__':
    ...
    # Run all, for testing convergence with different rho values.
    run_all = False
